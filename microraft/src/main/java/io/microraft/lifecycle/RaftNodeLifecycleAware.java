 ...
 * <p>
 * {@link RaftNode} does not manage the lifecycle of the components provided
 * to it during construction. It only notifies the components that implement
 * this interface.
 * <p>
...
public interface RaftNodeLifecycleAware {
     ...
     * <p>
     * If an exception is thrown, {@link RaftNode} stops its start procedure
     * and immediately terminates itself.
     */
     ...
     * <p>
     * Exceptions thrown by implementations of this method are handled and
     * logged by {@link RaftNode}.
     */
