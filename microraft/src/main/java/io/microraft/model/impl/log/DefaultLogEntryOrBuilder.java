...
/**
 * The default impl of the {@link LogEntry} and {@link LogEntryBuilder} interfaces. When an instance of this class is created, it
 * is in the builder mode and its state is populated. Once all fields are set, the object switches to the DTO mode where it no
...
public class DefaultLogEntryOrBuilder
    ...
    @Nonnull @Override public LogEntryBuilder setIndex(long index) {
        builder.index = index;
        return this;
    }

    @Nonnull @Override public LogEntryBuilder setTerm(int term) {
        builder.term = term;
        return this;
    }

    @Nonnull @Override public LogEntryBuilder setOperation(@Nonnull Object operation) {
        builder.operation = operation;
        return this;
    }

    @Nonnull @Override public LogEntry build() {
