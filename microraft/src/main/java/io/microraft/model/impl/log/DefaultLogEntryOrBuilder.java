...
/**
 * The default impl of the {@link LogEntry} and {@link LogEntryBuilder} interfaces. When an instance of this class is
 * created, it is in the builder mode and its state is populated. Once all fields are set, the object switches to the
