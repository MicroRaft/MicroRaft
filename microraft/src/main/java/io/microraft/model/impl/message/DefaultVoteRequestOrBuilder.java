...
/**
 * The default impl of the {@link VoteRequest} and {@link VoteRequestBuilder} interfaces. When an instance of this class
 * is created, it is in the builder mode and its state is populated. Once all fields are set, the object switches to the
 * DTO mode where it no longer allows mutations.
 * <p>
