 ...
 * <p>
 * A snapshot entry is also placed on a Raft log index, just like a regular log entry, but instead of user-provided
 * operations present in log entries, a snapshot entry contains objects that are returned from
 * {@link StateMachine#takeSnapshot(long, Consumer)}. Additionally, a snapshot entry contains the committed Raft group
