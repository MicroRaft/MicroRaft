...
public class FirewallTest
    ...
    public void when_messageIsDroppedForEndpoint_then_messageIsNotSentToThatEndpoint() {
        ...
        assertThat(firewall.shouldDrop(endpoint, mock(AppendEntriesRequest.class))).isTrue();
    }
    ...
    public void when_messageIsDroppedForEndpoint_then_messageIsSentToOtherEndpoint() {
        ...
        assertThat(firewall.shouldDrop(endpoint2, mock(AppendEntriesRequest.class))).isFalse();
    }
    ...
    public void when_messageIsDroppedForEndpoint_then_otherMessageTypeIsSentToThatEndpoint() {
        ...
        assertThat(firewall.shouldDrop(endpoint, mock(AppendEntriesRequest.class))).isFalse();
    }
    ...
    public void when_allMessagesAreDroppedForEndpoint_then_noMessageIsSentToThatEndpoint() {
        ...
        assertThat(firewall.shouldDrop(endpoint, mock(AppendEntriesRequest.class))).isTrue();
        assertThat(firewall.shouldDrop(endpoint, mock(AppendEntriesSuccessResponse.class))).isTrue();
        assertThat(firewall.shouldDrop(endpoint, mock(AppendEntriesFailureResponse.class))).isTrue();
        assertThat(firewall.shouldDrop(endpoint, mock(VoteRequest.class))).isTrue();
        assertThat(firewall.shouldDrop(endpoint, mock(VoteResponse.class))).isTrue();
        assertThat(firewall.shouldDrop(endpoint, mock(PreVoteRequest.class))).isTrue();
        assertThat(firewall.shouldDrop(endpoint, mock(PreVoteResponse.class))).isTrue();
        assertThat(firewall.shouldDrop(endpoint, mock(InstallSnapshotRequest.class))).isTrue();
        assertThat(firewall.shouldDrop(endpoint, mock(InstallSnapshotResponse.class))).isTrue();
        assertThat(firewall.shouldDrop(endpoint, mock(TriggerLeaderElectionRequest.class))).isTrue();
    }
    ...
    public void when_allMessagesAreDroppedForEndpoint_then_messagesAreSentToOtherEndpoint() {
        ...
        assertThat(firewall.shouldDrop(endpoint2, mock(AppendEntriesRequest.class))).isFalse();
        assertThat(firewall.shouldDrop(endpoint2, mock(AppendEntriesSuccessResponse.class))).isFalse();
        assertThat(firewall.shouldDrop(endpoint2, mock(AppendEntriesFailureResponse.class))).isFalse();
        assertThat(firewall.shouldDrop(endpoint2, mock(VoteRequest.class))).isFalse();
        assertThat(firewall.shouldDrop(endpoint2, mock(VoteResponse.class))).isFalse();
        assertThat(firewall.shouldDrop(endpoint2, mock(PreVoteRequest.class))).isFalse();
        assertThat(firewall.shouldDrop(endpoint2, mock(PreVoteResponse.class))).isFalse();
        assertThat(firewall.shouldDrop(endpoint2, mock(InstallSnapshotRequest.class))).isFalse();
        assertThat(firewall.shouldDrop(endpoint2, mock(InstallSnapshotResponse.class))).isFalse();
        assertThat(firewall.shouldDrop(endpoint2, mock(TriggerLeaderElectionRequest.class))).isFalse();
    }
    ...
    public void when_messageIsDroppedForAllEndpoints_then_messageIsNotSentToAnyEndpoint() {
        ...
        assertThat(firewall.shouldDrop(LocalRaftEndpoint.newEndpoint(), mock(AppendEntriesRequest.class))).isTrue();
        assertThat(firewall.shouldDrop(LocalRaftEndpoint.newEndpoint(), mock(AppendEntriesRequest.class))).isTrue();
    }
    ...
    public void when_messageIsDroppedForAllEndpoints_then_otherMessageTypeIsSentToEndpoints() {
        ...
        assertThat(firewall.shouldDrop(LocalRaftEndpoint.newEndpoint(), mock(VoteRequest.class))).isFalse();
        assertThat(firewall.shouldDrop(LocalRaftEndpoint.newEndpoint(), mock(VoteRequest.class))).isFalse();
    }
    ...
    public void when_multipleMessageTypesDroppedForEndpoint_then_allMessageTypesCanBeAllowedForEndpoint() {
        ...
        assertThat(firewall.shouldDrop(endpoint, mock(AppendEntriesRequest.class))).isFalse();
        assertThat(firewall.shouldDrop(endpoint, mock(VoteRequest.class))).isFalse();
    }
